...
public class First_Menu extends JFrame {
    ...
    public First_Menu(){
        ...
        label1.setIcon(new ImageIcon("src/mainmenu/img/red-yellow-retro.jpg"));
        label1.setBounds(0,0,626,481);

        label2 = new JLabel();
        label2.setOpaque(false);
        label2.setIcon(new ImageIcon("src/mainmenu/img/logo.png"));
        label2.setBounds(100,80,500,120);

        label3 = new JLabel();
        label3.setIcon(new ImageIcon("src/mainmenu/img/ENTER YOUR NICKNAME.png"));
       ...
       // button1.setIcon(new ImageIcon("src/mainmenu/img/button200x117.png"));
        ...
        label4 = new JLabel();
        label4.setIcon(new ImageIcon("src/mainmenu/img/PLAY.png"));
