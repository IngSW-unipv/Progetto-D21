...
class VictoryRowTest {
	...
	void testRiga() {
		...
		assertEquals("Failed", false, grid.checkRiga(5,4,TokenColor.YELLOW ));
	...
	void testRiga2() {
		...
		assertEquals("Failed", false, grid.checkRiga(5,3,TokenColor.RED ));
	...
	void testRiga3() {
		...
		assertEquals("Failed", false, grid.checkRiga(5,3,TokenColor.YELLOW ));
	...
	void testRiga4() {
		...
		assertEquals("Failed", true, grid.checkRiga(5,6,TokenColor.YELLOW ));
	...
	void testRiga5() {
		...
		assertEquals("Failed", true, grid.checkRiga(4,3,TokenColor.YELLOW ));
	...
	void testRiga6() {
		...
		assertEquals("Failed", false, grid.checkRiga(4,3,TokenColor.RED ));
	...
	void testRiga7() {
		...
		assertEquals("Failed", false, grid.checkRiga(2,1,TokenColor.YELLOW));
	...
	void testRiga8() {
		...
		assertEquals("Failed", false, grid.checkRiga(2,3,TokenColor.RED));
