...
class VictoryDiagonalTest {
	...
	void testDiagonal1() {
		...
		assertEquals("Failed", true, grid.checkDiagonali(2,3,TokenColor.YELLOW));
	}
	...
	void testDiagonal2() {
		...
		assertEquals("Failed", false, grid.checkDiagonali(2,0,TokenColor.YELLOW));
	}
	...
	void testDiagonal3() {
		...
		assertEquals("Failed", true, grid.checkDiagonali(2,0,TokenColor.RED));
	}
	...
	void testDiagonal4() {
		...
		assertEquals("Failed", false, grid.checkDiagonali(2,0,TokenColor.RED));
	}
	...
	void testDiagonal6() {
		...
		assertEquals("Failed", false, grid.checkDiagonali(1,2,TokenColor.YELLOW));
	}
	...
	void testDiagonal7() {
		...
		assertEquals("Failed", false, grid.checkDiagonali(0,4,TokenColor.RED));
	}
}
